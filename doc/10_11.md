# BYBIT COPYBOT PRO — TELEGRAM NOTIFICATION SYSTEM
...
### Health Checks (Run Before Sending START Message)
...
| Position closed | `POSITION STÄNGD` | Final close with full PnL |
...
Maximum leverage for all types: x50.00
